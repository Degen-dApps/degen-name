  ...
  <div class="row mt-3 text-center">
    <div class="col-md-8 offset-md-2">
      ...
      <div v-if="isUserMinterAdmin">
        ...
        <p>Current price: {{getMinterTldPrice1}} DEGEN</p>
      ...
      <div v-if="isUserMinterAdmin">
        ...
        <p>Current price: {{getMinterTldPrice2}} DEGEN</p>
      ...
      <div v-if="isUserMinterAdmin">
        ...
        <p>Current price: {{getMinterTldPrice3}} DEGEN</p>
      ...
      <div v-if="isUserMinterAdmin">
        ...
        <p>Current price: {{getMinterTldPrice4}} DEGEN</p>
      ...
      <div v-if="isUserMinterAdmin">
        ...
        <p>Current price: {{getMinterTldPrice5}} DEGEN</p>
